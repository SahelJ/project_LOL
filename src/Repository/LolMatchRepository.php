...
class LolMatchRepository extends ServiceEntityRepository
{
    ...
    public function add(LolMatch $entity, bool $flush = false): void
    {
    ...
    public function remove(LolMatch $entity, bool $flush = false): void
    {
...
//    /**
//     * @return LolMatch[] Returns an array of LolMatch objects
//     */
...
//    public function findOneBySomeField($value): ?LolMatch
//    {
//        return $this->createQueryBuilder('l')
//            ->andWhere('l.exampleField = :val')
//            ->setParameter('val', $value)
